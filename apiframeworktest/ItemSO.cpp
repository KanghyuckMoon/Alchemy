...
void ItemSO::Init()
{
	...
	//미소녀
	AddItemData(L"미소녀1_1", shared_ptr<ItemData>(new ItemData(L"미소녀1_1", L"미소녀1_N", L"미소녀1_T", L"Girl1")));
	AddItemData(L"미소녀2_1", shared_ptr<ItemData>(new ItemData(L"미소녀2_1", L"미소녀2_N", L"미소녀2_T", L"Girl2")));
	AddItemData(L"미소녀3_1", shared_ptr<ItemData>(new ItemData(L"미소녀3_1", L"미소녀3_N", L"미소녀3_T", L"Girl3")));
	AddItemData(L"미소녀4_1", shared_ptr<ItemData>(new ItemData(L"미소녀4_1", L"미소녀4_N", L"미소녀4_T", L"Girl4")));
	AddItemData(L"미소녀5_1", shared_ptr<ItemData>(new ItemData(L"미소녀5_1", L"미소녀5_N", L"미소녀5_T", L"Girl5")));
	AddItemData(L"미소녀6_1", shared_ptr<ItemData>(new ItemData(L"미소녀6_1", L"미소녀6_N", L"미소녀6_T", L"Girl6")));
	AddItemData(L"미소녀7_1", shared_ptr<ItemData>(new ItemData(L"미소녀7_1", L"미소녀7_N", L"미소녀7_T", L"Girl7")));
	AddItemData(L"미소녀8_1", shared_ptr<ItemData>(new ItemData(L"미소녀8_1", L"미소녀8_N", L"미소녀8_T", L"Girl8")));
	AddItemData(L"미소녀9_1", shared_ptr<ItemData>(new ItemData(L"미소녀9_1", L"미소녀9_N", L"미소녀9_T", L"Girl9")));

	AddItemData(L"미소녀1_2", shared_ptr<ItemData>(new ItemData(L"미소녀1_2", L"미소녀1_N", L"미소녀1_T", L"Girl1")));
	AddItemData(L"미소녀2_2", shared_ptr<ItemData>(new ItemData(L"미소녀2_2", L"미소녀2_N", L"미소녀2_T", L"Girl2")));
	AddItemData(L"미소녀3_2", shared_ptr<ItemData>(new ItemData(L"미소녀3_2", L"미소녀3_N", L"미소녀3_T", L"Girl3")));
	AddItemData(L"미소녀4_2", shared_ptr<ItemData>(new ItemData(L"미소녀4_2", L"미소녀4_N", L"미소녀4_T", L"Girl4")));
	AddItemData(L"미소녀5_2", shared_ptr<ItemData>(new ItemData(L"미소녀5_2", L"미소녀5_N", L"미소녀5_T", L"Girl5")));
	AddItemData(L"미소녀6_2", shared_ptr<ItemData>(new ItemData(L"미소녀6_2", L"미소녀6_N", L"미소녀6_T", L"Girl6")));
	AddItemData(L"미소녀7_2", shared_ptr<ItemData>(new ItemData(L"미소녀7_2", L"미소녀7_N", L"미소녀7_T", L"Girl7")));
	AddItemData(L"미소녀8_2", shared_ptr<ItemData>(new ItemData(L"미소녀8_2", L"미소녀8_N", L"미소녀8_T", L"Girl8")));
	AddItemData(L"미소녀9_2", shared_ptr<ItemData>(new ItemData(L"미소녀9_2", L"미소녀9_N", L"미소녀9_T", L"Girl9")));
	...
	AddItemData(L"구리 주괴힌트", shared_ptr<ItemData>(new ItemData(L"구리 주괴", L"구리 주괴_N", L"구리 주괴힌트_T", L"Copper Ingot")));
