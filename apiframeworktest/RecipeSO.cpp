...
void RecipeSO::Init()
{
	...
	//2
	AddExchange(L"가죽", L"미소녀2");
	AddExchange(L"미소녀2", L"양피지");
	AddExchange(L"양피지", L"미소녀2");

	AddExchange(L"구리 주괴", L"미소녀3");
	AddExchange(L"미소녀3", L"구리");
	AddExchange(L"구리", L"미소녀3");

	//3
	AddExchange(L"책", L"미소녀4");
	AddExchange(L"미소녀4", L"횃불");
	AddExchange(L"횃불", L"미소녀4");

	AddExchange(L"은괴", L"미소녀5");
	AddExchange(L"미소녀5", L"은");
	AddExchange(L"은", L"미소녀5");

	AddExchange(L"박스", L"미소녀6");
	AddExchange(L"미소녀6", L"고기");
	AddExchange(L"고기", L"미소녀6");

	//4
	
	//5
	AddExchange(L"금괴", L"미소녀7");
	AddExchange(L"미소녀7", L"금 열쇠");
	AddExchange(L"금 열쇠", L"미소녀7");
